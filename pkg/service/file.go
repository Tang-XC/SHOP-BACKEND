...
func (f *fileService) UploadImages(files []*multipart.FileHeader, token string) ([]model.FileResponse, error) {
...
func NewFileService(minioClient *minio.Client, config config.MinioConfig, userRepository repository.UserRepository) *fileService {
	return &fileService{
